...
test: $(SNC) | $(TMPDIR)
	...
	./$(SNC) examples/nullable_decimal.sn > $(TMPDIR)/snc_nullable_decimal.s
	$(CC) $(TMPDIR)/snc_nullable_decimal.s -o $(TMPDIR)/snc_nullable_decimal$(EXEEXT)
	./$(TMPDIR)/snc_nullable_decimal$(EXEEXT)
